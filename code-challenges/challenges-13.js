...
const objectCounter = (obj) => {
    return obj.reduce((count, currentObj) => count + 1, 0);
}
// -------------------------------------------------------------------------------------------------------
...
const statistics = (obj) => {
    return obj.reduce((acc, curr) => {
        const candidateName = curr.votes_To;
        acc[candidateName] = acc[candidateName] ? acc[candidateName] + 1 : 1;
        return acc;
      }, {});
}
// -------------------------------------------------------------------------------------------------------
